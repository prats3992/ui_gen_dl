...
class ColorMapper:
    ...
    def map_color_and_save(color_string, sorted_labels, hierarchy_file, level, save_csv_file, save_image_file):
        ...
        if sorted_labels is None:
            sorted_labels = UILabelFileManager.get_sorted_labels_for_hierarchy(
                sorted_label_file, hierarchy_file, level)
        label_color_map = ColorMapper.map_colors_to_labels(
            sorted_colors, sorted_labels)
    ...
    def save_color_map(label_color_map, save_image_file):
        ...
        for k, v in label_color_map.items():
            ...
            bottomLeftCornerOfText = (
                int(side * 1.5), (i * side) + int(side / 2))
...
if __name__ == "__main__":
    ...
    sorted_label_file = "../resources/ui_labels_sorted.csv"
    hierarchy_file = "../resources/ui_labels_hierarchy.csv"
    level = 1
    save_csv_file = "../resources/ui_labels_color_map.csv"
    save_image_file = "../resources/ui_labels_color.jpg"
    sorted_labels = [
        "text",
        "image",
        "log_in",
    ...
    ColorMapper.map_color_and_save(
        color_29, sorted_labels, hierarchy_file, level, save_csv_file, save_image_file)
